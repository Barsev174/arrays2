...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        printCorrectSecondArray(mirrorArray, correctArray);

        // Задача 7.
        System.out.println("Задача 7");
        printCorrectOneArray(mirrorArray);

        // Задача 8.
        System.out.println("Задача 8");
        int[] numbers = {-6, 2, 5, -8, 8, 10, 4, -7, 12, 1};
        printSumTwoNumbers(numbers);

        // Задача 9.
        System.out.println("Задача 9");
        printSumAllNumbers(numbers);
    }

    public static void PrintArray(int[] Book) {
    ...
    public static void printCorrectSecondArray(int[] mirrow, int[] correct) {
        for (int i = 0; i < mirrow.length; i++) {
            correct[mirrow.length - i - 1] = mirrow[i];
        }
        System.out.println("До преобразования - " + Arrays.toString(mirrow));
        System.out.println("После преобразования с использованием дополнителного массива- " + Arrays.toString(correct));
    }

    public static void printCorrectOneArray (int[] mirrorArray) {
    ...
    public static void printSumTwoNumbers(int[] numbers) {
        Arrays.sort(numbers);
    ...
    public static void printSumAllNumbers (int[] numbers) {
        for (int i = 0; i < numbers.length; i++) {
